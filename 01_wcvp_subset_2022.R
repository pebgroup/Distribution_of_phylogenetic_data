...
wcsp.names <- fread("data\\checklist_names.txt", quote = "") # WCVP names file
wcsp.distribution <- fread("data\\checklist_distribution.txt", quote = "") # WCVP distribution file

# Exclude fern and moss families
ferns <- fread("data\\fern_list.txt", quote = "", header = F, col.names = "family") # list of ferns
moss <- fread("data\\bryophyta_list.txt", quote = "", header = F, col.names = "family") # list of mosses
