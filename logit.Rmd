...
Load data:
```{r}
dat <- fread("C:\\Users\\alexa\\Documents\\SPECIALE\\publication\\220921\\results_2021\\seq_area_wolf_test_220921.csv")
...
Plot model:
```{r}
tiff(filename="C:\\Users\\alexa\\Documents\\SPECIALE\\publication\\220921\\results_2021\\fig220921\\logit_reg_HR.tiff",height=5600,width=5200,units= 'px' ,res=800,compression = 'lzw' )
