...
genbank.data <- fread("C:\\Users\\alexa\\Documents\\SPECIALE\\publication\\GenBank\\2803\\gb_280321(4).txt", quote = "")
...
synonym.translator <- fread("C:\\Users\\alexa\\Documents\\SPECIALE\\publication\\220921\\results_2021\\synonym_translator_220921.csv", quote = ",", header = T)
names.id <- fread("C:\\Users\\alexa\\Documents\\SPECIALE\\publication\\220921\\results_2021\\ID_and_Names_220921.csv", sep = ",", header = T)
...
write.table(fin.gb.list, "C:\\Users\\alexa\\Documents\\SPECIALE\\publication\\170621\\genbank_entries_170621.csv", sep = ",", row.names = F, col.names = T, quote = F)
...
write.table(species.all.markers, "C:\\Users\\alexa\\Documents\\SPECIALE\\publication\\220921\\results_2021\\genbank_entries_w_duplicates_220921.csv", sep = ",", row.names = F, col.names = T, quote = F)
